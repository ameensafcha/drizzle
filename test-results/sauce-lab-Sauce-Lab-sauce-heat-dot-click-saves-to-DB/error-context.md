...
- Name: sauce-lab.spec.ts >> Sauce Lab >> sauce heat dot click saves to DB
- Location: tests\sauce-lab.spec.ts:27:7
...
Call log:
  - waiting for locator('.modal [class*="grid"] > div').first().locator('.heat-dot').first()
